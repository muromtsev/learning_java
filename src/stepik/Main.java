...
public class Main {
    public static void main(String[] args) {
        ...
        // имея экземпляр конкретного класса, можно его присвоить,
        // например базовому классу
        Shape shape = triangle;
        // или Object
        Object object = triangle;
        // не требует приведение типа
        // приведение типа в обратную сторону, от базового к наследнику,
        // возможно толькоо явно, при помощи оператора приведения типа (Triangle)
