...
<h2 id="#1">Что такое ООП? В чем его плюсы? </h2>
...
<h2 id="#2"> Перечислите основные принципы ООП </h2>
...
<h2 id="#3">  Что такое инкапсуляция? Приведите пример инкапсуляции? </h2>
...
<h2 id="#4">  Что такое полиморфизм? Приведите пример полиморфизма? </h2>
...
<h2 id="#4">  Что такое наследование? Приведите пример наследования? Зачем оно нужно? </h2>
...
<h2 id="#5"> Что такое класс? Объект? </h2>
...
Почему важно переопределять hashCode()?
...
1. Фиксированный внутренний массив символов: Строки в Java хранят свои данные в неизменяемом массиве символов (char[]). Этот массив создается при инициализации строки и не может быть изменен напрямую.
